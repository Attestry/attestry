...
public record PassportDetailResponse(
    ...
    public static PassportDetailResponse from(PassportDetailResult result) {
    ...
    public record ShipmentResponse(
        ...
        public static ShipmentResponse from(ShipmentDetailResult r) {
    ...
    public record DistributionResponse(
        ...
        public static DistributionResponse from(DistributionDetailResult r) {
