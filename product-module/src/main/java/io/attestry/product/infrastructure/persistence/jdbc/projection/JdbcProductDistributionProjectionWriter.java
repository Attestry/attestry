...
@Component
public class JdbcProductDistributionProjectionWriter implements ProductDistributionProjectionWritePort {

    private final NamedParameterJdbcTemplate jdbcTemplate;

    public JdbcProductDistributionProjectionWriter(NamedParameterJdbcTemplate jdbcTemplate) {
