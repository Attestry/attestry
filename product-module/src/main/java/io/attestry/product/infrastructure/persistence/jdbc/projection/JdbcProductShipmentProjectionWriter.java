...
@Component
public class JdbcProductShipmentProjectionWriter implements ProductShipmentProjectionWritePort {

    private final NamedParameterJdbcTemplate jdbcTemplate;

    public JdbcProductShipmentProjectionWriter(NamedParameterJdbcTemplate jdbcTemplate) {
